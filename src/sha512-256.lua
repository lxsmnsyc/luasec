...
return function (message)
    ...
    mergeK() 
    local h0 = int64(0x22312194, 0xFC2BF72C)
    local h1 = int64(0x9F555FA3, 0xC84C64C2)
    local h2 = int64(0x2393B86B, 0x6F53B151)
    local h3 = int64(0x96387719, 0x5940EABD)
    local h4 = int64(0x96283EE2, 0xA88EFFE3)
    local h5 = int64(0xBE5E1E25, 0x53863992)
    local h6 = int64(0x2B0199FC, 0x2C85B8AA)
    local h7 = int64(0x0EB72DDC, 0x81C52CA2)
    ...
    -- since the 512-256 truncates the hash into 256 bits, we need to only get the first 4 of the hashes
