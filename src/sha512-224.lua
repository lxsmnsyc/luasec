...
return function (message)
    ...
    mergeK() 
    local h0 = int64(0x8C3D37C8, 0x19544DA2)
    local h1 = int64(0x73E19966, 0x89DCD4D6)
    local h2 = int64(0x1DFAB7AE, 0x32FF9C82)
    local h3 = int64(0x679DD514, 0x582F9FCF)
    local h4 = int64(0x0F6D2B69, 0x7BD44DA8)
    local h5 = int64(0x77E36F73, 0x04C48942)
    local h6 = int64(0x3F9D85A8, 0x6A1D36C8)
    local h7 = int64(0x1112E6AD, 0x91D692A1)
    ...
    -- since the 512-224 truncates the hash into 224 bits, we need to only get the first 3 1/2 of the hashes
    return tostring(h0)..tostring(h1)..tostring(h2)..tohex(h3.left)
end