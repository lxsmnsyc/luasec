...
local CK1 = oword(qword(0x517cc1b7, 0x27220a94), qword(0xfe13abe8, 0xfa9a6ee0))
local CK2 = oword(qword(0x6db14acc, 0x9e21c820), qword(0xff28b1d5, 0xef5de2b0))
local CK3 = oword(qword(0xdb92371d, 0x2126e970), qword(0x03249775, 0x04e8c90e))
...
m.new = function (a, b, c, d)
    local new = schedule(mergeOword(a, b, c, d))
    setmetatable(new, m)
    return new 
end
