...
return function (message)
    ...
    local h0 = int64(0xcbbb9d5d, 0xc1059ed8)
    local h1 = int64(0x629a292a, 0x367cd507)
    local h2 = int64(0x9159015a, 0x3070dd17)
    local h3 = int64(0x152fecd8, 0xf70e5939)
    local h4 = int64(0x67332667, 0xffc00b31)
    local h5 = int64(0x8eb44a87, 0x68581511)
    local h6 = int64(0xdb0c2e0d, 0x64f98fa7)
    local h7 = int64(0x47b5481d, 0xbefa4fa4)
